	...
	<div>
		<form class="pb-5" action="<%=ORSView.ORDER_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2"><%=HTMLUtility.getList1("customer", String.valueOf(dto.getCustomer()), map)%></div>
				...
				<div class="col-sm-2">
					<input type="text" name="productName"
						placeholder="Enter productName" maxlength="16"
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: blue;">
							...
							<th width="20%" class="text">Customer</th>
