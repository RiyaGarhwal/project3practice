...
<body>
 ...
 --%>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.ORDER_CTL%>"><i
							class="fas fa-calculator"></i>Add Order</a> <a class="dropdown-item"
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: Black;">Physician</font>

				</a>

					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.PHYSICIAN_CTL%>"><i
							class="fas fa-calculator"></i>Add Physician</a> <a
							class="dropdown-item" href="<%=ORSView.PHYSICIAN_LIST_CTL%>">
							<i class="fas fa-sort-amount-down"></i>Physician List
