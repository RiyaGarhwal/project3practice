<%@page import="in.co.rays.project_3.controller.PhysicianCtl"%>
						...
						<div class="card-body">
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<%=HTMLUtility.getList1("specialization", String.valueOf(dto.getSpecialization()), map)%>
								</div>
							</div>
							...
							<font color="red" class="pl-sm-5" id="phone">
								<%=ServletUtility.getErrorMessage("phone", request)%></font></br>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=PhysicianCtl.OP_UPDATE%>"> <input
									type="submit" name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=PhysicianCtl.OP_CANCEL%>">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=PhysicianCtl.OP_SAVE%>"> <input
									type="submit" name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=PhysicianCtl.OP_RESET%>">
							</div>
