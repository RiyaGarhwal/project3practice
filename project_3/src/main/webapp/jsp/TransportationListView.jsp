	...
	<div>
		<form class="pb-5" action="<%=ORSView.TRANSPORTATION_LIST_CTL%>"
			...
			<%
				...
				Map map = (Map) request.getAttribute("trans");
			...
			<div class="row">
				...
				<div class="col-sm-2"><%=HTMLUtility.getList1("mode", String.valueOf(dto.getMode()), map)%></div>

				<div class="col-sm-2">
					<input type="text" name="cost" placeholder="Enter Cost"
						maxlength="16" class="form-control" id="number"
						oninput="handleDoubleInput(this, 'costError', 4)"
						onblur="handleDoubleInput(this, 'costError',4)"
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=map.get(Integer.parseInt(dto.getMode()))%></td>
