	...
	<div>
		<form class="pb-5" action="<%=ORSView.TRADEHISTORY_LIST_CTL%>"
			...
			<%
				...
				Map map = (Map) request.getAttribute("trad");
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="userId" placeholder="Enter "
						userId"" maxlength="16" class="form-control" id="number"
				...
				<div class="col-sm-2">
					<input type="text" name="startDate"
						placeholder="Enter startDate" id="datepicker"
				...
				<div class="col-sm-2">
					<input type="text" name="endDate"
						placeholder="Enter endDate" id="datepicker2"
						class="form-control" readonly="readonly"
