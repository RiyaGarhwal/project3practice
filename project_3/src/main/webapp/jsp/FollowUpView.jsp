						...
						<div class="card-body">
							...
							<div>
								<%
									...
									Map map = (Map) request.getAttribute("clien");
									Map map1 = (Map) request.getAttribute("physi");
								%>
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<%=HTMLUtility.getList1("physician", String.valueOf(dto.getPhysician()), map1)%>
								</div>
							</div>
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="charges"
										placeholder="charges"
										oninput="handleDoubleInput(this, 'chargesError', 4)"
											onblur="handleDoubleInput(this, 'chargesError',4)"
										value="<%=(DataUtility.getStringData(dto.getCharges()).equals("0.0") ? "" : dto.getCharges())%>">								</div>
							</div>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=FollowUpCtl.OP_SAVE%>"> <input
									type="submit" name="operation" class="btn btn-warning btn-md"
