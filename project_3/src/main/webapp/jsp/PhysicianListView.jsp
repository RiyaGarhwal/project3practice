<%@page import="in.co.rays.project_3.controller.PhysicianListCtl"%>
<%@page import="in.co.rays.project_3.dto.PhysicianDTO"%>
...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.PHYSICIAN_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.PhysicianDTO"
				scope="request"></jsp:useBean>


			<%
				int pageNo = ServletUtility.getPageNo(request);
				Map map = (Map) request.getAttribute("physi");
				...
				Iterator<PhysicianDTO> it = list.iterator();
				if (list.size() != 0) {
			%>
			<center>
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="birthDate" placeholder="Enter birthDate"
						id="datepicker2" class="form-control" readonly="readonly"
						value="<%=ServletUtility.getParameter("birthDate", request)%>">
				</div>

				<div class="col-sm-2"><%=HTMLUtility.getList1("specialization", String.valueOf(dto.getSpecialization()), map)%></div>
				...
				<div align="center">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=PhysicianListCtl.OP_SEARCH%>"> &emsp; <input
						type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
						name="operation" value="<%=PhysicianListCtl.OP_RESET%>">
				</div>
			</div>
			<br>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: blue;">
							...
							<th width="15%" class="text">BirthDate</th>
							<th width="20%" class="text">Phone</th>
							<th width="20%" class="text">Specialization</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=DataUtility.getDateString(dto.getBirthDate())%></td>
							<td class="text"><%=dto.getPhone()%></td>
							<td class="text"><%=map.get(Integer.parseInt(dto.getSpecialization()))%></td>

							<td class="text"><a href="PhysicianCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=PhysicianListCtl.OP_PREVIOUS%>"
					...
					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=PhysicianListCtl.OP_NEXT%>"
			...
			<div class="row">
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=PhysicianListCtl.OP_BACK%>">
				</div>
